export const categoryMeta = {
  'Trail spines': {swatch:'#0b7a75ff', copy:'Main trails, trail corridors, and core route ideas.'},
  'Ride anchors': {swatch:'#a0512dff', copy:'Important destinations, trailheads, and personal ride anchors.'},
  ...
  'Rider Amenities': {swatch:'#0ea5e9ff', copy:'Water fountains and bike repair stations from OpenStreetMap.'}
};
